...
export default function BannerMembers({ channels, members, totalMembers }) {
    console.log(members)

    const viewAllMembers = () => {
        console.log('view all members modal')
    }

    const addMember = () => {
        console.log('add members given a channel')
    }
  return (
      <div className='channel-members'>
          <div className='channel-members-pics' onClick={viewAllMembers}>
          ...
          <div className='channel-members-add' onClick={addMember}>
